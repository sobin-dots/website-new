    ...
    <section className="pt-20 pb-10 bg-white text-slate-900 text-center">
      <div className="mx-auto max-w-7xl px-6 md:px-8 space-y-10">
        ...
        <div className="space-y-5 max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-primary leading-tight font-serif italic">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 pt-4 max-w-4xl mx-auto">
          {categories.map((cat) => (
            <button
              ...
              className={`rounded-full px-5 py-2 text-xs font-semibold border transition-all duration-300 ${
                activeTab === cat.name

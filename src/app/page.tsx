...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="flex flex-col min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[95vh] lg:min-h-screen flex items-center overflow-hidden bg-foreground text-white pt-28 pb-32 lg:py-0">
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-8 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            {/* Left Hero Text */}
            <div className="relative lg:col-span-6 space-y-6 md:space-y-8 animate-in fade-in slide-in-from-left-4 duration-500">
              ...
              <div className="block lg:hidden">
                ...
                <div className="absolute -bottom-48 right-0 rounded-2xl bg-white/10 backdrop-blur-md p-3.5 shadow-xl border border-white/20 text-white min-w-[130px] animate-in fade-in zoom-in-95 duration-700 delay-400">
                  <div className="text-2xl font-serif font-normal tracking-tight">94%</div>
                  <div className="text-[9px] text-white/80 font-sans mt-0.5 max-w-[110px] leading-tight">Reduction in documentation time</div>
                </div>
              </div>
